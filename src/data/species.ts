...
export const SPECIES: TreeSpecies[] = [
  ...
  },
  {
    id: 'spruce',
    name: 'Ель',
    description: 'Вечнозелёная и неприхотливая — с возрастом набирает стабильно высокий доход.',
    cost: 20000,
    baseIncome: 100,
    growthRate: 1.6,
    unlockAt: 60000,
    trunk: '#5c4a3a',
    foliage: ['#2f5233', '#3f6b45'],
  },
  {
    id: 'baobab',
    name: 'Баобаб',
    description: 'Исполин саванны с исполинским стволом — дорогой, но и доход соответствующий.',
    cost: 80000,
    baseIncome: 260,
    growthRate: 1.9,
    unlockAt: 250000,
    trunk: '#8a7259',
    foliage: ['#a9a13a', '#c4bb55'],
  },
  {
    id: 'sequoia',
    name: 'Секвойя',
    description: 'Самое величественное и щедрое дерево из всех — но и найти его непросто.',
    cost: 320000,
    baseIncome: 650,
    growthRate: 2.2,
    unlockAt: 1000000,
    trunk: '#7a3b2e',
    foliage: ['#2e5940', '#3f7a56'],
  },
];
